...
import com.xuchg.controller.TaskFlowController;
...
public class MainWindow extends Application {
	...
	private static TaskFlowController taskFlowController = null;
	...
	public void start(Stage arg0) throws Exception {
		...
		Platform.runLater(new Runnable() {
		    ...
		    public void run() {
				...
				if(null != context){
					taskFlowController = context.getBean(TaskFlowController.class);
				}
				stage =  new Stage();
    ...
    public WebView getBodyView() {
        ...
        String dataPath = basePath + "/.task_flow_designer/temp";
        ...
        woker.stateProperty().addListener((obs, oldValue, newValue) -> {
            if (newValue == Worker.State.SUCCEEDED) {
                ...
                jsObject.setMember("taskFlowController", taskFlowController);
                //初始化
                String list = taskFlowController.getAll();
                jsObject.call("initList", list);
            }
        });
